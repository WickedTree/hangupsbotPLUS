...
def covid19(bot, event, *args):
    try:   
        ...
        html_text = "<strong>The COVID-19 outbreak internationally has " + cases + " cases and " + deaths + " deaths. Stay home for all our safety " + "</strong><br /><i>Original Plugin by gubareve</i>"
    except:
